	...
	<div class="large-9 columns">
		...
		<section class="home-section row">
			<div class="large-7 columns">
				...
				<hr>
				<p>Parce que nous n'avons pas le temps de perdre du temps, UrbanGirl vous propose une navigation innovante et sur-mesure. Indiquez-nous votre profil grâce aux indications ci-dessus, puis naviguez à votre gré ! <i class="icon-twitter"></i></p>
			</div>
